...
plt.xlabel(u'Mês', size=fontsize)
plt.xticks(index, ('Fev', 'Abr', 'Jun', 'Ago','Out', 'Dez'), size=fontsize)
plt.ylabel('Intensidade do Vento (m/s)', size=fontsize)
plt.ylim([0,6])
plt.xlim([1,12])
plt.savefig(pathname + '\\media_int_vento_mensal.png', format='png', dpi=1200)
...
ax.set_ylabel(u'Frequência (%)', size=18)
ax.set_xlabel(u'Horas do dia', size=18)
plt.savefig(pathname + '\\frequencia_direcao.png', 
            format='png', 
            dpi=1200)
...
ax.set_xlabel('Horas', size=fontsize)
ax.set_ylabel('Intensidade do Vento (m/s)', size=fontsize)
ax.set_title('')
plt.suptitle('')
plt.savefig(pathname + '\\intensidade_vento_hora.png', 
            format='png', 
            dpi=1200)
...
ax = dados.boxplot(column=['Velvento'],
                    ...
                    figsize=figsize,
                    fontsize=18)
ax.set_xlabel(u'Direção do Vento', size=fontsize)
ax.set_ylabel('Intensidade do Vento (m/s)', size=fontsize)
ax.set_title('')
plt.suptitle(u'Intensidade do vento 2008 - 2016', size=fontsize+1)
plt.savefig(pathname + '\\intensidade_vento_direcao.png', 
            format='png', 
            dpi=1200)
...
ax.set_ylim([0,1])
ax.set_yticklabels([0, 20, 40, 60, 80, 100])
ax.set_xticklabels(meses_label.keys())
ax.set_ylabel(u'Frequência (%)', size=fontsize)
ax.set_xlabel(u'Meses do Ano', size=fontsize)
plt.savefig(pathname + '\\frequencia_direcao_mensal.png', 
            format='png', 
            dpi=1200)
...
ax.set_ylabel('Intensidade do Vento (m/s)', size=fontsize)
ax.set_title('')
plt.suptitle(u'Intensidade do vento mensal', size=fontsize+1)
plt.savefig(pathname + '\\intensidade_vento_mensal.png', 
            format='png', 
            dpi=1200)
